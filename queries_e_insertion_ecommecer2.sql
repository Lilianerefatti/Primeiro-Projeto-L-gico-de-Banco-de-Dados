...
show tables;
-- Cliente: idClient, Fname, Minit, Lname, CPF, Address
insert into clients (Fname, Mint, Lname, CPF, Adress, email, datacadastro) values
		('João', 'A.', 'Silva', '12345678901', 'Rua A, 123', 'joao.silva@email.com', '2024-01-15'),
		('Maria', 'B.', 'Oliveira', '23456789012', 'Rua B, 456', 'maria.oliveira@email.com', '2024-02-20'),
		('Carlos', 'C.', 'Souza', '34567890123', 'Rua C, 789', 'carlos.souza@email.com', '2024-03-05'),
		('Ana', 'D.', 'Pereira', '45678901234', 'Rua D, 101', 'ana.pereira@email.com', '2024-04-18'),
		('Fernanda', 'E.', 'Mendes', '56789012345', 'Rua E, 202', 'fernanda.mendes@email.com', '2024-05-10'),
		('Paulo', 'F.', 'Costa', '67890123456', 'Rua F, 303', 'paulo.costa@email.com', '2024-06-25'),
		('Ricardo', 'G.', 'Lima', '78901234567', 'Rua G, 404', 'ricardo.lima@email.com', '2024-07-14'),
		('Juliana', 'H.', 'Nascimento', '89012345678', 'Rua H, 505', 'juliana.nascimento@email.com', '2024-08-30'),
		('Felipe', 'I.', 'Gomes', '90123456789', 'Rua I, 606', 'felipe.gomes@email.com', '2024-09-22'),
		('Renata', 'J.', 'Ribeiro', '01234567890', 'Rua J, 707', 'renata.ribeiro@email.com', '2024-10-05');
